...
#Q-learning
    ...
    for m in range(max_iterations):
        ...
        QlearningError[m] = error1/(math.sqrt((horizons+1)*No_of_states))
        QlearningErrorSOR[m] = error2/(math.sqrt((horizons+1)*No_of_states))
...
#Plotting value Function
    ...
    plt.plot(np.arange(No_of_states), valueMatrixLearned[0, :], '-',label='Q-learning ')
...
#plt.show()
    ...
    plt.plot(np.arange(No_of_states), policyMatrixLearned[0, :], '-',label='Q-learning ')
...
#plt.axis([0, min(5000,max_iterations), 0, 0.50])
    ...
    #plt.axis([0, m, 0, 50])
    plt.plot(QlearningError, label= 'Q-learning')
    #plt.ylim(0,5)
    #plt.yscale("log")
    # plot6 = plt.figure()
    # x = np.arange(max_iterations)
    plt.plot(QlearningErrorSOR, label='SOR')
    #plt.ylim(0, 5)
    #plt.yscale("log")
